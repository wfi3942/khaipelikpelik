...
urlpatterns = [
    ...
    url(r'^carList/$', 'assets.views.carList'),
    url(r'^carAdd/$', 'assets.views.carAdd'),
    url(r'^carDel/$', 'assets.views.carDel'),
    url(r'^carDetail/$', 'assets.views.carDetail'),
    url(r'^carAddinfo/$', 'assets.views.carinfoAdd'),
    url(r'^carEdit/$', 'assets.views.carEdit'),
]
