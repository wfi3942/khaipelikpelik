...
CREATE TABLE `agent` (
  ...
  `agent_status` varchar(5) NOT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `assets_car` VALUES ('7', 'No.1', '', '0', '0', '0', '0');
INSERT INTO `assets_car` VALUES ('8', 'No.2', '2021/10/04', '0', '10', '0', '0');
...
-- ----------------------------
-- Records of assets_carlist
-- ----------------------------
INSERT INTO `assets_carlist` VALUES ('1', '2021/10/03', '0', '0', '0', '111', '1');
INSERT INTO `assets_carlist` VALUES ('2', '2021/10/04', '0', '10', '0', '121', '1');
INSERT INTO `assets_carlist` VALUES ('3', '2021/10/03', '0', '0', '0', '12', '2');
INSERT INTO `assets_carlist` VALUES ('4', '2021/10/04', '0', '10', '0', '22', '2');
INSERT INTO `assets_carlist` VALUES ('5', '2021/10/05', '0', '10', '0', '22', '2');
...
-- ----------------------------
-- Records of assets_carmodel
-- ----------------------------
INSERT INTO `assets_carmodel` VALUES ('1', 'No.1', '111');
INSERT INTO `assets_carmodel` VALUES ('2', 'No.2', '12');
...
-- ----------------------------
-- Table structure for browserhistory
-- ----------------------------
DROP TABLE IF EXISTS `browserhistory`;
CREATE TABLE `browserhistory` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `browser_type` varchar(128) COLLATE utf8mb4_bin NOT NULL,
  `browser_url` varchar(6000) COLLATE utf8mb4_bin NOT NULL,
  `browser_datetime` varchar(32) COLLATE utf8mb4_bin NOT NULL,
  `browser_title` varchar(6000) COLLATE utf8mb4_bin NOT NULL,
  `uid` varchar(128) COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22309 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- ----------------------------
-- Records of browserhistory
-- ----------------------------
...
-- ----------------------------
INSERT INTO `department` VALUES ('1', 'sre', '', '1');
...
INSERT INTO `django_session` VALUES ('1x2c2u9wisiwib453ae0y2bvlbrskzwk', '', '2021-11-06 14:18:50.140763');
INSERT INTO `django_session` VALUES ('mek85mgs8kuir0mpmnvv5lqlbdlu0zjq', '', '2021-11-05 14:49:54.693723');
INSERT INTO `django_session` VALUES ('zrbdxb3r7yzf1b1eah2jrsxe8x9e3302', '', '2021-11-06 07:21:06.746724');
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', 'dashboard', 'dashboard', '/dashboard/index/', '1', 'fa-bar-chart-o', '0', 'dashboard');
INSERT INTO `menu` VALUES ('2', 'staff Log', 'assets', '#', '1', 'fa-desktop', '0', 'assets');
...
INSERT INTO `menu` VALUES ('23', 'UserMange', 'accounts', '#', '1', 'fa-user', '0', 'accounts');
INSERT INTO `menu` VALUES ('24', 'DeparTment', 'departmentList', '/accounts/departmentList/', '1', '', '23', 'departmentList departmentAdd');
INSERT INTO `menu` VALUES ('25', '添加部门', 'departmentAdd', '/accounts/departmentAdd/', '1', '', '24', 'departmentList departmentAdd');
INSERT INTO `menu` VALUES ('26', 'UserList', 'userList', '/accounts/userList/', '1', '', '23', 'userList userAdd');
INSERT INTO `menu` VALUES ('27', '添加用户', 'userAdd', '/accounts/userAdd/', '1', '', '26', 'userList userAdd');
INSERT INTO `menu` VALUES ('28', 'AuthMange', 'auth', '#', '1', 'fa-ban', '0', 'auth');
INSERT INTO `menu` VALUES ('29', 'MenuList', 'menuAdminList', '/auth/menuAdminList/', '1', '', '28', 'menuAdminList menuAdminAdd');
...
INSERT INTO `menu` VALUES ('34', 'dashboard', 'index', '/dashboard/index/', '1', '', '1', 'dashboard');
...
INSERT INTO `menu` VALUES ('37', 'staff Log', 'monitorList', '/monitor/agent-List/', '1', '', '2', 'agent-List');
...
-- Records of myuser
-- ----------------------------
INSERT INTO `myuser` VALUES ('1', 'pbkdf2_sha256$20000$DYS1J412ozE5$8jxicCjxDxS7SO+nD0nv5pZAbn4kwIsgHECLtfK2h/0=', '2021-10-23 14:18:50', '1', 'cmdbAdmin', 'systemUser', '', '', '1', '1', '2017-03-28 08:12:21', '', '', '', '1', '1');
...
-- ----------------------------
INSERT INTO `myuser_auth` VALUES ('281', '1', '30');
INSERT INTO `myuser_auth` VALUES ('280', '1', '29');
INSERT INTO `myuser_auth` VALUES ('279', '1', '28');
INSERT INTO `myuser_auth` VALUES ('278', '1', '27');
INSERT INTO `myuser_auth` VALUES ('277', '1', '26');
INSERT INTO `myuser_auth` VALUES ('276', '1', '25');
INSERT INTO `myuser_auth` VALUES ('275', '1', '24');
INSERT INTO `myuser_auth` VALUES ('274', '1', '23');
INSERT INTO `myuser_auth` VALUES ('273', '1', '37');
INSERT INTO `myuser_auth` VALUES ('272', '1', '2');
INSERT INTO `myuser_auth` VALUES ('271', '1', '34');
INSERT INTO `myuser_auth` VALUES ('270', '1', '1');
